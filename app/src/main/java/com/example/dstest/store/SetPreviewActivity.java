...
import com.example.dstest.DB;
import com.example.dstest.ImageAdapter;
import com.example.dstest.ImageItem;
import com.example.dstest.R;
import com.example.dstest.TTS;
    ...
    void load(){
        ...
        picServer.getCategory(category, new PicServer.OnPicServerResponce(){
            ...
            public void onImageItems(ImageItem[] items) {
                ...
                context.items = items;
                adapter = new ImageAdapter(context, R.layout.grid_item, items);
